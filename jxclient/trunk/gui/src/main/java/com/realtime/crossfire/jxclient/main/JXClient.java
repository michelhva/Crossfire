                            ...
                            try {
                                ...
                                SwingUtilities.invokeAndWait(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        final JXCSkinLoader jxcSkinLoader = new JXCSkinLoader(model.getItemSet(), inventoryView, floorView, spellsView, spellSkillsView, model.getSpellsManager(), facesManager, model.getStats(), mapUpdaterState, defaultKeyBindings, optionManager, model.getExperienceTable(), model.getSkillSet(), options.getTileSize(), keybindingsManager, model.getQuestsManager(), questsView, commandHistoryFactory, model.getKnowledgeManager(), knowledgeView, knowledgeTypesView, options.isAvoidCopyArea());
