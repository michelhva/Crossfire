...
public class JXCSkinPrelude implements JXCSkin
{
    ...
    public Gui getMainInterface(CrossfireServerConnection myserver, JXCWindow p) throws JXCSkinException
    {
        ...
        try
        {
            ...
            command_magicmap_display.add(new GUICommand(gui_magicmap_content, GUICommand.Command.SHOW, ""));
            command_magicmap_display.add(new GUICommand(gui_magicmap, GUICommand.Command.SHOW, ""));

            command_magicmap_undisplay.add(new GUICommand(gui_magicmap_content, GUICommand.Command.HIDE, ""));
            command_magicmap_undisplay.add(new GUICommand(gui_magicmap, GUICommand.Command.HIDE, ""));
            ...
            command_magicmap_undisplay.add(new GUICommand(gui_btn_magicmap_show, GUICommand.Command.SHOW, ""));
            command_magicmap_undisplay.add(new GUICommand(gui_btn_magicmap_hide, GUICommand.Command.HIDE, ""));
            command_magicmap_display.add(new GUICommand(gui_btn_magicmap_show, GUICommand.Command.HIDE, ""));
            command_magicmap_display.add(new GUICommand(gui_btn_magicmap_hide, GUICommand.Command.SHOW, ""));
            ...
            command_rinv_up.add(new GUICommand(gui_rinv0, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinv1, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinv2, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinv3, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinv4, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinv5, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinv6, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinv7, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinv8, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinv9, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvA, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvB, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvC, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvD, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvE, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvF, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvG, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvH, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvI, GUICommand.Command.SCROLLUP, ""));
            command_rinv_up.add(new GUICommand(gui_rinvJ, GUICommand.Command.SCROLLUP, ""));

            command_rinv_down.add(new GUICommand(gui_rinv0, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinv1, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinv2, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinv3, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinv4, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinv5, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinv6, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinv7, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinv8, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinv9, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvA, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvB, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvC, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvD, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvE, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvF, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvG, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvH, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvI, GUICommand.Command.SCROLLDOWN, ""));
            command_rinv_down.add(new GUICommand(gui_rinvJ, GUICommand.Command.SCROLLDOWN, ""));

            command_rsp_up.add(new GUICommand(gui_rsp0, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rsp1, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rsp2, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rsp3, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rsp4, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rsp5, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rsp6, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rsp7, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rsp8, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rsp9, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspA, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspB, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspC, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspD, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspE, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspF, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspG, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspH, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspI, GUICommand.Command.SCROLLUP, ""));
            command_rsp_up.add(new GUICommand(gui_rspJ, GUICommand.Command.SCROLLUP, ""));

            command_rsp_down.add(new GUICommand(gui_rsp0, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rsp1, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rsp2, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rsp3, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rsp4, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rsp5, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rsp6, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rsp7, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rsp8, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rsp9, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspA, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspB, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspC, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspD, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspE, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspF, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspG, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspH, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspI, GUICommand.Command.SCROLLDOWN, ""));
            command_rsp_down.add(new GUICommand(gui_rspJ, GUICommand.Command.SCROLLDOWN, ""));
            ...
            command_rsp_display.add(new GUICommand(gui_rinv1, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinv2, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinv3, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinv4, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinv5, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinv6, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinv7, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinv8, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinv9, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvA, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvB, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvC, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvD, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvE, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvF, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvG, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvH, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvI, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rinvJ, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_rsp0, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rsp1, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rsp2, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rsp3, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rsp4, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rsp5, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rsp6, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rsp7, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rsp8, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rsp9, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspA, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspB, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspC, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspD, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspE, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspF, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspG, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspH, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspI, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_rspJ, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_btn_rsp_up, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_btn_rsp_down, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_btn_rinv_up, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_btn_rinv_down, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_panel_spells, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_panel_spells_icon, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_panel_spells_name, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_panel_spells_description, GUICommand.Command.SHOW, ""));

            command_rsp_undisplay.add(new GUICommand(gui_rsp0, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rsp1, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rsp2, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rsp3, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rsp4, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rsp5, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rsp6, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rsp7, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rsp8, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rsp9, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspA, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspB, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspC, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspD, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspE, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspF, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspG, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspH, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspI, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rspJ, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv0, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv1, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv2, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv3, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv4, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv5, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv6, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv7, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv8, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinv9, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvA, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvB, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvC, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvD, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvE, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvF, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvG, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvH, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvI, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_rinvJ, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_btn_rsp_up, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_btn_rsp_down, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_btn_rinv_up, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_btn_rinv_down, GUICommand.Command.SHOW, ""));
            command_rsp_undisplay.add(new GUICommand(gui_panel_spells, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_panel_spells_icon, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_panel_spells_name, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_panel_spells_description, GUICommand.Command.HIDE, ""));
            ...
            command_rsp_undisplay.add(new GUICommand(gui_btn_rsp_undisplay, GUICommand.Command.HIDE, ""));
            command_rsp_undisplay.add(new GUICommand(gui_btn_rsp_display, GUICommand.Command.SHOW, ""));
            command_rsp_display.add(new GUICommand(gui_btn_rsp_display, GUICommand.Command.HIDE, ""));
            command_rsp_display.add(new GUICommand(gui_btn_rsp_undisplay, GUICommand.Command.SHOW, ""));
    ...
    public Gui getMetaInterface(CrossfireServerConnection myserver, JXCWindow p) throws JXCSkinException
    {
        ...
        try
        {
            ...
            command_metaup.add(new GUICommand(gui_metaselect1, GUICommand.Command.SCROLLUP, ""));
            command_metaup.add(new GUICommand(gui_metaselect2, GUICommand.Command.SCROLLUP, ""));
            command_metaup.add(new GUICommand(gui_metaselect3, GUICommand.Command.SCROLLUP, ""));
            command_metaup.add(new GUICommand(gui_metaselect4, GUICommand.Command.SCROLLUP, ""));
            command_metaup.add(new GUICommand(gui_metaselect5, GUICommand.Command.SCROLLUP, ""));
            command_metaup.add(new GUICommand(gui_metaselect6, GUICommand.Command.SCROLLUP, ""));
            command_metaup.add(new GUICommand(gui_metaselect7, GUICommand.Command.SCROLLUP, ""));
            command_metaup.add(new GUICommand(gui_metaselect8, GUICommand.Command.SCROLLUP, ""));

            command_metadown.add(new GUICommand(gui_metaselect1, GUICommand.Command.SCROLLDOWN, ""));
            command_metadown.add(new GUICommand(gui_metaselect2, GUICommand.Command.SCROLLDOWN, ""));
            command_metadown.add(new GUICommand(gui_metaselect3, GUICommand.Command.SCROLLDOWN, ""));
            command_metadown.add(new GUICommand(gui_metaselect4, GUICommand.Command.SCROLLDOWN, ""));
            command_metadown.add(new GUICommand(gui_metaselect5, GUICommand.Command.SCROLLDOWN, ""));
            command_metadown.add(new GUICommand(gui_metaselect6, GUICommand.Command.SCROLLDOWN, ""));
            command_metadown.add(new GUICommand(gui_metaselect7, GUICommand.Command.SCROLLDOWN, ""));
            command_metadown.add(new GUICommand(gui_metaselect8, GUICommand.Command.SCROLLDOWN, ""));

            command_metaconnect.add(new GUICommand(gui_metaurl, GUICommand.Command.CONNECT, p));
            command_metacancel.add(new GUICommand(null, GUICommand.Command.GUI_START, p));
    ...
    public Gui getStartInterface(CrossfireServerConnection myserver, JXCWindow p) throws JXCSkinException
    {
        ...
        try
        {
            ...
            command_startmenu_meta.add(new GUICommand(null, GUICommand.Command.GUI_META, p));
            command_startmenu_quit.add(new GUICommand(null, GUICommand.Command.QUIT, p));
    ...
    public Gui getDialogBook(CrossfireServerConnection myserver, JXCWindow p, int booknr) throws JXCSkinException
    {
        ...
        try
        {
            ...
            default:
                ...
                command_book_close.add(new GUICommand(null, GUICommand.Command.GUI_LEAVE_DIALOG, p));
