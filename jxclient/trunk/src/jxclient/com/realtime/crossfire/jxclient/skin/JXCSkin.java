...
{
    void load(CrossfireServerConnection crossfireServerConnection, JXCWindow window, Metaserver metaserver, CommandQueue commandQueue, Resolution resolution, OptionManager optionManager) throws JXCSkinException;
