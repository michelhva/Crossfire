...
public class JXCSkinLoader
{
    ...
    public JXCSkin load(final JXCSkinSource skinSource, final CrossfireServerConnection crossfireServerConnection, final JXCWindow window, final MouseTracker mouseTracker, final MetaserverModel metaserverModel, final CommandQueue commandQueue, final Resolution resolution, final Shortcuts shortcuts, final Commands commands, final CurrentSpellManager currentSpellManager, final GuiManager guiManager, final boolean debugGui) throws JXCSkinException
    {
        ...
        skin.reset();
        imageParser.clear();
        skin.addDialog("keybind", mouseTracker, commands, guiManager);
        skin.addDialog("query", mouseTracker, commands, guiManager);
        skin.addDialog("book", mouseTracker, commands, guiManager);
        skin.addDialog("main", mouseTracker, commands, guiManager);
        skin.addDialog("meta", mouseTracker, commands, guiManager);
        skin.addDialog("quit", mouseTracker, commands, guiManager);
        skin.addDialog("disconnect", mouseTracker, commands, guiManager);
        skin.addDialog("start", mouseTracker, commands, guiManager);
        definedFonts.clear();
