...
RM = /bin/rm
TARGET = gcfclient cfclient cfsndserv
CFLAGS = -g -O2 -DOSS_SOUND -DNEW_SOUND -Wall   -I.
LDFLAGS =  
CC = gcc
LIBS = -lm -ldmalloc  -lXpm
INSTALL = /usr/bin/install -c
DEPEND = /usr/X11R6/bin/makedepend
PERL = /usr/bin/perl
SOUND_DIR = /usr/local/lib/sounds
...
GTK_LIBS=-L/usr/lib -L/usr/X11R6/lib -lgtk -lgdk -lglib -lXi -lXext -lX11 -lm
SND_LIBS=-lm
...
all:  gcfclient cfclient cfsndserv def-keys.h
