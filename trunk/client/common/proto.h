...
extern void AddspellCmd(unsigned char *data, int len);
extern void UpdspellCmd(unsigned char *data, int len);
extern void DeleteSpell(unsigned char *data, int len);
...
extern char *get_number(uint32 i);
...
extern void set_item_values(item *op, char *name, sint32 weight, uint16 face, uint16 flags, uint16 anim, uint16 animspeed, uint32 nrof, uint16 type);
extern void toggle_locked(item *op);
extern void send_mark_obj(item *op);
extern item *player_item(void);
extern item *map_item(void);
extern void update_item(int tag, int loc, char *name, int weight, int face, int flags, int anim, int animspeed, uint32 nrof, int type);
...
extern char *getLogTextRaw(LogLevel level, const char *origin, const char *message);
extern char *getLogText(const LogEntry *le);
extern void LOG(LogLevel level, const char *origin, const char *format, ...);
...
extern char GetChar_String(const unsigned char *data);
...
extern int cs_print_string(int fd, const char *str, ...);
/* player.c */
